...
export function fillDemoState(state) {
    ...
    state.relationship = {
        ladder: [
            { id: 'r1', title: 'Чужие люди из одного здания', note: 'Виделись в лифте и на этаже, но ни разу не заговорили.', reached: true },
            { id: 'r2', title: 'Вынужденные союзники', note: 'Общая проблема заставляет держаться вместе, доверия в этом ещё нет.', reached: true },
            { id: 'r3', title: 'Свои в чужом городе', note: 'Друг для друга — единственный понятный человек рядом.', reached: true },
            { id: 'r4', title: 'Опасная близость', note: 'Тянет друг к другу, и оба делают вид, что этого нет.', reached: true },
            { id: 'r5', title: 'Сказано вслух', note: 'Названо словами то, что происходит между ними.' },
            { id: 'r6', title: 'Живут этим вместе', note: 'Общие планы, общий риск, общая жизнь.' },
        ],
        phase: 'r4',
        nextStep: 'Кто-то из них должен вслух назвать то, что между ними происходит, — пока оба обходят это стороной.',
